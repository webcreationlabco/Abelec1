...
const MEGA_COL_KEYS = [
  ...
  },
  {
    ...
    hrefs: [CAT, CAT, CAT, CAT, CAT, CAT, CAT, CAT, CAT],
  },
  {
    key: "fridge",
    ...
    hrefs: [CAT, CAT, CAT, "/produit/thermostat-liebherr-ts-r59l1102", CAT, CAT, CAT],
  },
  {
    key: "oven",
    ...
    hrefs: ["/produit/resistance-four-brandt-rf-78954", CAT, CAT, CAT, CAT, CAT, CAT],
  },
  {
    key: "dryer",
    partsKey: "mega.dryerParts",
    counts: [58, 86, 92, 88, 64],
    hrefs: [CAT, CAT, CAT, CAT, CAT],
  },
  {
    key: "vacuum",
    ...
    hrefs: [CAT, "/produit/filtre-hepa-dyson-hepa-dy-r", CAT, CAT, CAT],
  },
];
      ...
      >
        <div className="relative max-w-[1240px] mx-auto grid grid-cols-[1fr_auto_1fr] max-sm:grid-cols-[1fr_1fr] items-center px-4 sm:px-8 py-[14px] sm:py-[18px]">
          ...
          <div className="flex items-center gap-1 justify-end">
            ...
            <Link href="/compte" className="w-9 h-9 rounded-lg grid place-items-center text-abelec-navy-ink hover:bg-abelec-navy/[0.06] transition-colors" aria-label={t("nav.myAccount")}>
        ...
        {scrolled && (
          ...
          >
            ...
            <div className="flex items-center gap-0.5 shrink-0">
              ...
              <Link href="/compte" className="w-8 h-8 rounded-full grid place-items-center text-abelec-navy-ink hover:bg-abelec-navy/[0.06] transition-colors" aria-label={t("nav.myAccount")}>
